...
Let $\theta_j^c$ be a candidate distribution where
...
#+begin_quote
TODO: Fill out more here from slides when posted.
#+end_quote
...
#+begin_quote
Special Case of Metropolis sampling where acceptance rate is always 1.
#+end_quote
...
between chains should agree. Very similar to ANOVA!
