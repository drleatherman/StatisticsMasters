...
\label{first:main}
\begin{align}
\|\vec x\|_1 \leq \|\vec x - \vec z_S\|_1 = & \| \vec v_S\|_1 + \| \vec z_S \|_1 < \| \vec z_S\|_1 + \| \vec v_S\|_1\\
= & \| - \vec z_{\bar S} \| + \| z_S\|_1\\
= & \| \vec z \|_1
\end{align}
\end{subequations}
...
#+begin_quote
Didn't quite understand the jump between b -> c
#+end_quote
...
_Intuition_: *Hopefully*, the matrix $A* A$ behaves like the Identity Matrix. $(I
- A*A)$ is small.
